...
let conversationHistoryRecords = {};
...
async function callLLM(userInput, conversationId) {
  let conversationHistory = conversationHistoryRecords[conversationId];
  ...
  if (!conversationHistory) {
    ...
    conversationHistoryRecords[conversationId] =
      conversationHistory;
  }
